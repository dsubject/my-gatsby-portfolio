...
const ResumePage = () => {
  return (
    <Layout>
      ...
      <p>
        I'm an English Major turned software developer. My main experience
        consists of full stack JavaScript development and native Android
        development in Kotlin, with frameworks such as ReactJS, React Native,
        and Angular. Currently, my interest lies in Blockchain development and
        sustainable IT.
      </p>
      ...
      <ul>
        <li>
          Outlining and presenting green software concepts through the phases of
          the software development lifecycle
        </li>
        <li>Native Android development in Kotlin</li>
        <li>Implemented RESTful api data consumption using Retrofit</li>
        <li>
          Dev Ops: Implemented a Bamboo pipeline to ensure easy deployment for
          the client
        </li>
        <li>Led a full accessibility audit of Storybook UI components</li>
        <li>
          Integrated analytics tagging to track user interactions on a Storybook
          application using Angular
        </li>
        <li>Write unit tests to achieve client's desired coverage</li>
        <li>
          Led the integration for a remote cheque deposit SDK feature on
          multiple projects
        </li>
        <li>Work closely with QA testers to enforce accessibility standards</li>
        <li>Provide testing and defect support to clients</li>
        <li>
          Created an Android framework written in kotlin to meet client's needs
          for a resuable library
        </li>
        <li>Solely built a POC application in Android from the ground up</li>
        <li>
          Utilized Adobe Experience Manager Forms and Adobe Designer to build
          interactive forms for the client
        </li>
        <li>
          Tested crash rate of an SDK with custom logs using Firebase and
          Crashlytics
        </li>
      </ul>
      ...
      <ul>
        <li>
          A video assessment tool used to reduce unconscious bias during the
          hiring process.
        </li>
        <li>Implemented new features using WebRTC API</li>
        <li>
          Led accessibility audit and implemented accessible features to meet
          legal criteria
        </li>
      ...
      <ul style={{ paddingBottom: 20 }}>
        <li>
          Responsible for educating a MERN Stack curriculum, as well as
          PostgreSQL, Git, and deployment flow
        </li>
